...
(function(factory) {
    ...
    var Utils = {
        ...
        createStylesheet: function(id) {
            ...
            return this._fixupStylesheetProxy(style);
        },

        /**
         * Return Proxy style sheet for styles if needed. See class
         * documentation for details.
         */
        _fixupStylesheetProxy: function(style) {
            if (style.sheet) {
                return style.sheet;
            }
            return new ProxyStyleSheet(style);
        },
    ...
    */
    ...
    /**
     * Salesforce gives us a `Proxy` object on the HTML DOM elements, which
     * does not return the `sheet` property (it comes back as `undefined`).
     * To fix this, we need to manually implement the required method here.
     */
    var ProxyStyleSheet = function(style) {
        this._style = style;
    };

    /* Index is ignored, we don't need it. */
    ProxyStyleSheet.prototype.insertRule = function(rule, index) {
